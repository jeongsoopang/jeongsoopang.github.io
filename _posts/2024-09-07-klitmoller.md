...
excerpt: "Cold Hawaii — wind, waves, and the raw beauty of the North Sea."

header:
  teaser: /assets/images/history/denmark/klitmoller/klitmoller.jpg
...
회사 사람들과 점심을 먹다 casually 흘러나온 이야기,  
**덴마크의 콜드 하와이**.

바람과 파도가 만들어내는 거친 풍경,  
서퍼들이 모여드는 북해의 작은 마을이라는 설명이  
괜히 마음에 오래 남았다.  
한 번쯤은 꼭 가보고 싶다는 생각이 들었다.

문제는 이동.  
Klitmøller까지 가는 대중교통은 현실적으로 거의 없었고  
알아보다가 포기하려던 찰나,  
회사 동료가 **Klitmøller 근처 summer house**에서  
주말을 보내고 월요일에 Aarhus로 출근한다는 이야기를 듣게 된다.

금요일 퇴근 후,  
혹시 Klitmøller까지 태워줄 수 있겠냐고 조심스럽게 물었고  
조금 돌아가야 함에도 흔쾌히 수락해주셨다.

그렇게 시작된  
**Klitmøller (Cold Hawaii)** 로 향한 나의 이야기.
...
<video controls muted playsinline preload="metadata">
  <source src="/assets/images/history/denmark/klitmoller/first-dinner.mov" type="video/mp4">
</video>
...
바람이 거의 없어  
생각보다 잔잔한 바다였지만,  
그래도 **Cold Hawaii에서 서핑을 한다는 것** 자체로  
이미 충분히 즐거운 시간이었다.

나는  
**2박 숙소 + 3타임 강습 패키지**를 결제했고  
강습에는 바디슈트, 신발, 서핑보드까지  
모두 포함되어 있었다.

Klitmøller의 바닷속은  
돌과 죽은 산호로 이루어져 있어  
넘어지거나 바닥에 발을 디디면 꽤 아프다.  
(슈즈를 신어도 아프다…)
...
<div class="image-grid-2">
  <img src="/assets/images/history/denmark/klitmoller/7-lunch-after-first-surfing.jpg" alt="">
  <img src="/assets/images/history/denmark/klitmoller/12-lunch-after-sauna.jpg" alt="">
</div>

첫 타임을 마치고  
서핑샵 옆 식당에서  
**grilled chicken burger**와 **Tuborg** 한 잔.
...
잠시 숙소에서 쉬었다가  
저녁으로 목살을 구워 먹은 뒤,  
Klitmøller에서 일몰로 유명한 바닷가로 다시 걸어 나왔다.

풀숲에 앉아  
챙겨온 맥주와 올리브를 꺼내 놓고  
서서히 내려앉는 해를 바라본다.

덴마크까지 오는 여정을 걱정하던 순간들,  
이곳에서의 생활을 고민하던 시간들.
...
<video controls muted playsinline preload="metadata">
  <source src="/assets/images/history/denmark/klitmoller/sunset.MOV" type="video/mp4">
</video>
...
<div class="image-grid-2">
  <img src="/assets/images/history/denmark/klitmoller/11-sauna-after-last-surfing.jpg" alt="">
  <img src="/assets/images/history/denmark/klitmoller/15-waytosummerhouse2.jpg" alt="">
</div>

강습 패키지에 포함된  
**핀란드 사우나**를 요청하고  
덥혀지는 동안 식당에서  
**Fish & Chips**와 **Tuborg Classic**으로 배를 채웠다.

바다를 마주한 사우나에서  
몸을 녹이고,  
파도에 긴장했던 근육들을 천천히 풀어준다.
...
<a href="https://www.youtube.com/watch?v=WvbmSyuXtSo" target="_blank" class="youtube-embed-link">
  <img 
    ...
    alt="Cold Hawaii — Klitmøller Surf Vlog"
    class="youtube-thumbnail">
</a>
<p class="youtube-caption">
  <a href="https://www.youtube.com/watch?v=WvbmSyuXtSo" target="_blank">
